...
module.exports.prototype = {
    ...
    getRoutes: function(){
        ...
        if (self.routes.length === 0){
            ...
            var routes;
            try {
                routes = self.readFile(self.options.rootPath + self.options.routesFile);
            }
            catch (e) {
                throw new Error('The specified routes file (' + self.options.routesFile + ') does not exist or could not be read.')
            }
